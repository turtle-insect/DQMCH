...
namespace DQMCH
{
	internal class Info
	{
		...
		public List<NameValueInfo> Store { get; private set; } = new List<NameValueInfo>();
		public List<NameValueInfo> Job { get; private set; } = new List<NameValueInfo>();
		...
		private void Init()
		{
			...
			AppendList("info\\store.txt", Store);
			AppendList("info\\job.txt", Job);
		}
